...
A full stack fitness application built with Blazor and SQLite. Build custom workouts, run live training sessions, log meals and macros, track body progress, and share it with friends.
